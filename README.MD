...
**NeuroSolidTG** leverages Large Language Models (LLMs) alongside symbolic execution to generate high-coverage test cases and detect vulnerabilities. This is first of its kind neurosymbolic analysis tool.
